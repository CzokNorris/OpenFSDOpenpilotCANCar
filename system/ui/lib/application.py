...
class GuiApplication:
  ...
  def _set_styles(self):
    ...
    rl.gui_set_style(rl.GuiControl.DEFAULT, rl.GuiDefaultProperty.BACKGROUND_COLOR, _s32(rl.color_to_int(rl.BLACK)))
    rl.gui_set_style(rl.GuiControl.DEFAULT, rl.GuiControlProperty.TEXT_COLOR_NORMAL, _s32(rl.color_to_int(DEFAULT_TEXT_COLOR)))
    rl.gui_set_style(rl.GuiControl.DEFAULT, rl.GuiControlProperty.BASE_COLOR_NORMAL, _s32(rl.color_to_int(rl.Color(50, 50, 50, 255))))
